...
import com.springboot.jpa.hibernate.main.Application;
...
@SpringBootTest(classes = Application.class)  // to run the spring context(IOC)
public class CourseRepositoryImplTest {
    ...
    public void sampleTest() {
        ...
        log.info("Test-class is running");
    }
